using PushbulletSharpCore.Filters;
using PushbulletSharpCore.Models.Requests;
using PushbulletSharpCore.Models.Requests.Ephemerals;
using PushbulletSharpCore.Models.Responses;
using System;
